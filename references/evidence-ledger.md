...
- **真实成片验证覆盖。** 目前 `user_verified` 成片证据:Kling 3.0 Standard 单人 `actor_cut`(`[USER-K3-01]`~`[USER-K3-04]`)、Seedance 2.5 30s 告别独白(`[USER-SD25-01]`,单一情绪递进)、Seedance 2.5 30s 争吵戏(`[USER-SD25-02]`,受激分层递进),以及一条 Seedance 2.0 失败教训(`[USER-SD20-01]`)。注意:两条 2.5 成功样本同属"夜内景/越肩/年轻女性/关系戏"窄域,跨域结论保持 experimental。
